<%-- 
    Document   : index
    Created on : Feb 9, 2016, 4:48:29 PM
    Author     : m@pc
--%>
                ...
                <div class="header_top">
                    ...
                    <div class="header_top_right">
                        ...
                        <ul class="header_user_info">
                            <a class="login" href="/proversion1/controller?action=login">
                                <i class="user"> </i> 
                ...
                <div class="header_bottom">
                    ...
                    <div class="menu">
                        <ul class="megamenu skyblue">
                            ...
                            <li><a class="color4" href="/proversion1/controller?action=vegitable" >Vegetables</a></li>				
                            <li><a class="color10" href="brands.html">Meals</a></li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="clearfix"> </div>
